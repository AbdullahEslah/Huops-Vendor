  ...
  Widget build(BuildContext context) {
    return BasePageWithoutNavBar(
      ...
      body: Column(
        ...
        children: [
          Image.asset("assets/images/contact_us.png", width: 300).centered(),
          "Tab on button to chat with support"
              .tr()
              .text
              .gray400
              .medium
          ...
          "Get in touch".tr().text.xl4.white.semiBold.make(),
          ...
          GestureDetector(
            onTap: () {
              launchUrlString('https://wa.me/+201068780588',
          ...
          GestureDetector(
            onTap: () {
              launchUrlString('mailto:support@huopsapp.com',
                  mode: LaunchMode.externalApplication);
            },
            child: Card(
              elevation: 1,
          ...
          GestureDetector(
            onTap: () {
              launchUrlString('tel:+201068780588',
                  mode: LaunchMode.externalApplication);
            },
            child: Card(
              elevation: 2,
          ...
          GestureDetector(
            onTap: () {
              launchUrlString('https://www.huopsapp.com',
                  mode: LaunchMode.externalApplication);
            },
            child: Card(
              elevation: 2,

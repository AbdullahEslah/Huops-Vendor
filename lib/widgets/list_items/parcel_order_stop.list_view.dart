  ...
  Widget build(BuildContext context) {
    return VStack(
      [
        VStack(
          [
            "${widget.title}".text.gray300.medium.sm.make(),
            "${widget.stop.deliveryAddress?.name}".text.xl.white.medium.make(),
            "${widget.stop.deliveryAddress?.address}".text.white.make(),
          ],
        ),
        //route
        Visibility(
        ...
        HStack(
          [
            "Contact Info".tr().text.gray300.medium.sm.make().expand(),
            //
            Icon(
        ...
        Visibility(
          ...
          child: HStack(
            [
              ...
              VStack(
                [
                  "Recipient Name".tr().text.gray300.medium.sm.make(),
                  "${widget.stop.name}"
                      .text
                      .medium
                      .xl.white
